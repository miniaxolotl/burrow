...
func (t *TunnelRegistry) Register(ctx context.Context, tunnelID string, port uint16, userID *int64, clientIP string) (string, error) {
	if err := t.redis.SetTunnel(ctx, tunnelID, port, userID, clientIP, 24*time.Hour); err != nil {
